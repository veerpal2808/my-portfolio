...
export const EMAIL_JS_SERVICE_ID = 'service_btctlkt';
export const EMAIL_JS_TEMPLATE_ID = 'template_bss1qf8';
export const EMAIL_JS_PUBLIC_KEY = 'zNttYyPR-j__AiITC';